/* ============================================================
   ...
   Used by pages that don't yet have a real backend endpoint —
   real API-backed pages (menu/wastage overview) do not use this.
   ============================================================ */
...
export const FORECAST_DAILY = [
  { day: 'Sep 19', actual: 4120, forecast: null, low: null, high: null },
...
export const FORECAST_WEEKLY = [
  { day: 'W38', actual: 28640, forecast: null, low: null, high: null },
...
export const FORECAST_MONTHLY = [
  { day: 'Jun', actual: 99800, forecast: null, low: null, high: null },
