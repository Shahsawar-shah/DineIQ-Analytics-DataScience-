...
import { NotificationRow } from '../ui/InsightCard'
  ...
  const sidebarBody = (
    <>
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        {!collapsed && <p className="sidebar-heading !mt-0">{ROLE_LABEL[role]}</p>}
        {nav.map((item) => {
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden text-left sm:block">
                    <span className="block text-xs font-bold leading-tight text-ink-900">{user?.name}</span>
