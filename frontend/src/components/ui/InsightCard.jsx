...
export function RecommendationCard({ area, title, detail, impact, confidence, delay = 0 }) {
...
export function ForecastCard({ label, value, range, delta, delay = 0 }) {
...
export function NotificationRow({ icon: Icon, color, title, text, time }) {
  return (
...
export function MiniStat({ icon, color, label, value }) {
  return (
