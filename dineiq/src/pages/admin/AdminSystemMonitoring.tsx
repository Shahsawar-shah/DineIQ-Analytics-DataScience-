  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4 xl:grid-cols-4">
        {[
          { icon: Cpu, label: 'Cluster CPU', value: '64%', tone: 'amber' as const },
          { icon: MemoryStick, label: 'Memory', value: '71%', tone: 'amber' as const },
          { icon: HardDrive, label: 'Storage', value: '52%', tone: 'green' as const },
          { icon: Wifi, label: 'Network I/O', value: '38%', tone: 'green' as const },
        ].map((r, i) => (
