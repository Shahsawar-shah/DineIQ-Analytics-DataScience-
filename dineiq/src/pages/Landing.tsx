...
import {
  ArrowRight, BarChart3, BellDot, BrainCircuit, CalendarCheck, ChevronDown, CheckCircle2,
  Database, FlaskConical, Gauge, LineChart, Mail, MapPin, Megaphone, Menu as MenuIcon,
  Package, Phone, Quote, ShoppingBag, Sparkles, Star, Tags, TrendingUp, TriangleAlert,
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6">
        <Link to="/" className="flex items-center gap-2.5">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-brand-400 to-brand-600 font-display text-lg font-extrabold text-white shadow-lg shadow-brand-500/40">
            D
          </span>
          <span>
...
function Hero() {
  return (
    <section id="home" className="hero-vignette relative flex min-h-screen items-center overflow-hidden">
      ...
      {/* floating stat chips (parallax feel via CSS float) */}
...
const TICKER_ITEMS = [
  ...
  { icon: UsersIcon, text: 'Customer Intelligence' },
...
const FEATURES = [
  ...
  { icon: Zap, title: 'Anomaly Detection', desc: 'Automatic alerts when revenue, orders or wastage deviate from expected ranges.' },
]
...
function Footer() {
  const cols = [
    {
      title: 'Platform',
      links: ['Sales Analytics', 'Menu Intelligence', 'Customer Intelligence', 'Forecasting', 'Wastage Analytics'],
    },
    {
      title: 'For Teams',
      links: ['Restaurant Managers', 'Inventory Managers', 'Administrators', 'Customers'],
    },
    {
      title: 'Resources',
      links: ['Documentation', 'Mock Data Notes', 'API Preview', 'Support'],
    },
  ]
  return (
        ...
        <div className="grid gap-10 pb-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2.5">
              <span className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-brand-400 to-brand-600 font-display text-lg font-extrabold text-white">
                D
              </span>
              <span>
                <span className="font-display block text-lg font-extrabold leading-none text-white">
